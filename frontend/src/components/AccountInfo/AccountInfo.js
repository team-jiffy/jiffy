...
class AccountInfo extends React.Component{
  ...
  onSave = e=>{
    ...
    axios({
      method:'post',
      url : "localhost:8080/user/updatePassword",
      data : {
        UID:"abc",
        Password :  password
      }
  ...
  render() {
    return (
      <div id="AccountInfo" style={{height:this.state.height1}}>
        ...
        <hr className="line"/>
        <br/>
        <div id="content" style={{height:this.state.height2}}>
          <div id="UserPass"> 
            <p>
              <span className="text address">Location:</span>
              <span className="text address">Mint Ave. San Francisco</span>
            ...
            <p>
              ...
              <span className="text email">jybd@gmail.com</span>
          ...
          <div id="ChangePass" style={{display:this.state.block}}> 
